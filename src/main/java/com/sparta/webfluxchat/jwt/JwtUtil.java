package com.sparta.webfluxchat.jwt;


import com.sparta.webfluxchat.entity.UserRoleEnum;
...
public class JwtUtil {
    ...
    @Value("${jwt.secret.key}") // Base64 Encode 한 SecretKey -> application에서 값 가져오는, @Value이용해서 가져옴.
