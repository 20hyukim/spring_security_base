...
import com.sparta.webfluxchat.jwt.JwtAuthenticationFilter;
import com.sparta.webfluxchat.jwt.JwtAuthorizationFilter;
import com.sparta.webfluxchat.jwt.JwtUtil;
import com.sparta.webfluxchat.security.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.formLogin((formLogin) ->
                formLogin
                        .loginPage("/api/user/login-page").permitAll()//로그인 페이지
        );
